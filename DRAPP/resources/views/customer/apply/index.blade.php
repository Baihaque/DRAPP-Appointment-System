                ...
                <input type="hidden" name="doctor_id" value="{{$data['doctor']->id}}">
                    <div class="card-text">
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    <img src="upload_images/{{$data['doctor']->picture}}" id="preview" class="img-thumbnail">
                                </div>
                            </div>
                            <div class="col-md-10">
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="date" id="date" class="form-control" value="{{$data['appointment_date']}}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="time">Time</label>
                                            <input type="time" name="time" id="time" class="form-control" value="{{$data['appointment_time']}}"
                                                readonly>
                                        </div>
                                    </div>
                                </div>
